		...
		<div id="list-robo" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="nomeConfiguracao" title="${message(code: 'robo.nomeConfiguracao.label', default: 'Nome Configuracao')}" />
					
						<g:sortableColumn property="alavancagem" title="${message(code: 'robo.alavancagem.label', default: 'Alavancagem')}" />
					
						<g:sortableColumn property="quantidadeCandles" title="${message(code: 'robo.quantidadeCandles.label', default: 'Quantidade Candles')}" />
				...
				<g:each in="${roboInstanceList}" status="i" var="roboInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${roboInstance.id}">${fieldValue(bean: roboInstance, field: "nomeConfiguracao")}</g:link></td>
					
						<td>${fieldValue(bean: roboInstance, field: "alavancagem")}</td>
					
						<td>${fieldValue(bean: roboInstance, field: "quantidadeCandles")}</td>
